...
with st.sidebar.container():
    ...
    p = st.sidebar.select_slider("Prävalenz (%) (Standard: 0.1%):", prevalence, 1, format_func=lambda x: f'{x:.2f}%')
    ve = st.sidebar.slider("Impfstoffwirksamkeit (%) (Standard 66%):", 0, 100, 66, 1, format='%d%%')
